...
export const buttonHeaderGarage = createElement(
  'button',
  { className: 'button header__garage', textContent: 'TO GARAGE' },
) as HTMLButtonElement;
buttonHeaderGarage.disabled = true;
export const buttonHeaderWinner = createElement(
  'button',
  { className: 'button header__winner', textContent: 'TO WINNER' },
) as HTMLButtonElement;
